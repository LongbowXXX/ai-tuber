...
graph LR
    ...
    subgraph "Frontend & Services"
        direction LR
        VS[vtube-stage<br/>Electron App & MCP Server]
...
- **`vtube-stage`**: レンダリングエンジン兼オーケストレーター。Electron アプリケーションとして動作し、MCP Server を内蔵。React + Three.js で VRM モデルを描画し、VoiceVox と連携して発話とリップシンクを行います。
