...
## 出力：
- `slide_progression_decision_reason` に現在のスライドを進めるか進めないかを決定する理由を Step By Step で説明します。  
   AIタレントが `what_to_explains` の各項目について説明済みかを確認したうえで、AIタレントがまだ説明していない項目を列挙してください。
