...
| ファイル                              | 目的                                 | 主要なセクション                                     |
| :------------------------------------ | :----------------------------------- | :--------------------------------------------------- |
| `architecture/overview.md`            | システム概要と設計の根拠             | コンポーネント、図、設計上の決定                     |
...
| `glossary.md`                         | ユビキタス言語と定義                 | 主要な用語、ドメイン概念、略語                       |
...
```markdown
<!-- このドキュメントは .github/prompts/doc-sync.prompt.md によって生成および更新されます -->
